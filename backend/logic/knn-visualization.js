...
export default class KNNVisualization extends Visualization {
  constructor(data, options, types, k = defaultK) {
    ...
    document
      .querySelector(this.options.rootNode)
      .appendChild(this.createSettings());
  ...
  addEventListeners() {
    ...
    this.onChangeInput("weighted", "checkbox", [
      this.checkboxWeightedChangeCallback,
    ]);
  }
  svgClickCallback(circle) {
    ...
    this.drawConnectingLines(
      this.mapClosestNeighborsToConnectingLines(classifiedCircle),
    );
  ...
  drawCircles() {
    ...
    this.svg
      ...
      .style("fill", function (d) {
        ...
        return d.type === defaultType || d.fill === typeColor
          ? d.fill
          : typeColor;
      });
  }
